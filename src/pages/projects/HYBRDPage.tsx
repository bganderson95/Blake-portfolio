...
const logoBreakdown = [
  ...
  {
    label: "Heartbeat",
    text: 'The crossbar of the "H" breaks into a zig-zag, nodding to a heart rate monitor and reinforcing the cardio side of the brand.',
  },
  {
    label: "Plates",
  ...
  return (
    <ProjectLayout project={project}>
        ...
        <div className="hybrd-logo-breakdown">
          ...
          <div className="hybrd-logo-details">
            ...
            <p className="hybrd-logo-footnote">
              This concept was ultimately retired in favor of something simpler,
              but it was a fun problem to design through.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="project-section">
        ...
        <p className="project-page-caption">
          One of several prototype flows — the following covers the workout
        ...
        <div className="hybrd-dev-section">
          <div className="hybrd-dev-text">
            <p className="project-page-description" style={{ marginBottom: 0 }}>
              Beyond the design work, I participated in a HYBRD internal
              hackathon. My submission tackled post-workout benchmark tracking:
              after completing a workout, the app automatically compared each
              activity result against the user's existing personal bests and
              updated any benchmarks that were beaten.
            </p>
            <p className="project-page-description" style={{ marginBottom: 0 }}>
              The centerpiece of the feature was a confetti cannon that fired
              whenever a user improved their HYBRD score. It was the kind of
              detail that made an otherwise data-heavy moment feel like a
              genuine celebration. The confetti cannon still ships in the app
              today.
            </p>
          </div>
